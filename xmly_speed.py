...
SCKEY = 'SCT8108T5XTLFVmuEZ2HBRPDsc5ffDWp'                  # Server酱的SCKEY; secrets可填
...
UserAgent = "Mozilla/5.0 (huawei; CPU android OS 13_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 iting/1.0.12 kdtunion_iting/1.0 iting(main)/1.0.12/ios_1"
